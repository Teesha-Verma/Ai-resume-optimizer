...
import { Mail, Lock, UserIcon, Eye, EyeOff, ArrowRight, Sparkles } from 'lucide-react';
        ...
        <div className="relative bg-gradient-to-b from-[#0f1328] to-[#090d1a] rounded-2xl border border-[var(--border)] shadow-[0_32px_80px_rgba(0,0,0,0.6)] overflow-hidden">
          ...
          <div className="px-8 pt-6 pb-8">
            <form onSubmit={handleSignupSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="group w-full mt-4 py-3.5 bg-[var(--amber)] text-black font-mono text-[12px] font-bold tracking-[0.12em] uppercase rounded-xl transition-all duration-300 hover:bg-[#fbbf24] hover:shadow-[0_8px_32px_rgba(245,158,11,0.25)] hover:-translate-y-px active:translate-y-0 cursor-none flex items-center justify-center gap-2"
              >
                Sign Up
